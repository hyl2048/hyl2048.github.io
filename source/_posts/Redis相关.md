...
[Redis官方文档](https://redis.io/documentation)(EN)

[Redis文档](http://redisdoc.com/string/index.html)(CH)
...
![image](https://hadyang.github.io/interview/docs/basic/database/redis/images/f0dacdd3779b836ad75fe6b886af1fff.png)

### 为啥 Redis 单线程模型也能效率这么高？（能加速数据检索的原因）

- 纯内存操作（基于内存操作，数据读写全部在内存中完成）
- 核心是基于非阻塞的 IO 多路复用机制
- 单线程反而避免了多线程的频繁上下文切换问题
#### 常见问题
[用管道加速 Redis 查询](https://jyjsjd.github.io/redis/redis-pipeline/)
...
![img](https://hadyang.github.io/interview/docs/basic/database/redis/images/1c5e07626a9cadd5f1ea8acd85838067.png)
...
![img](https://hadyang.github.io/interview/docs/basic/database/redis/images/3de376ea57386b890483b27cf131f24d.png)
...
![img](https://hadyang.github.io/interview/docs/basic/database/redis/images/5e6b9afd23ff44415b434d05ed0449ce.png)
...
![img](https://hadyang.github.io/interview/docs/basic/database/redis/images/c807b7a0af060a874fdb27abf5caf289.png)
...
![img](https://hadyang.github.io/interview/docs/basic/database/redis/images/redis-master-slave.png)
...
![img](https://hadyang.github.io/interview/docs/basic/database/redis/images/a9832e14ba184a4049f979e521ef050b.png)
...
![img](https://hadyang.github.io/interview/docs/basic/database/redis/images/cc9ac0419ae3f5059076c2d66f867931.png)
...
![img](https://hadyang.github.io/interview/docs/basic/database/redis/assists/redis_ziplist_struct.png)
